...
const SERVICE_ID: &str = "adi.i18n.cli.es-ES";

extern "C" fn plugin_info() -> PluginInfo {
    PluginInfo::new("adi.cli.es-ES", "ADI CLI - Español", "1.0.0", "translation")
        .with_author("ADI Team")
        .with_description("Spanish translations for ADI CLI")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        let host = (*ctx).host();
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.cli.es-ES")
                .with_description("Spanish translations for ADI CLI");
        ...
        host.info("ADI CLI Spanish translation plugin initialized");
    }
    0
}
