...
const SERVICE_ID: &str = "adi.i18n.cli.ru-RU";

extern "C" fn plugin_info() -> PluginInfo {
    PluginInfo::new("adi.cli.ru-RU", "ADI CLI - Русский", "1.0.0", "translation")
        .with_author("ADI Team")
        .with_description("Russian translations for ADI CLI")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        let host = (*ctx).host();
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.cli.ru-RU")
                .with_description("Russian translations for ADI CLI");
        ...
        host.info("ADI CLI Russian translation plugin initialized");
    }
    0
}
