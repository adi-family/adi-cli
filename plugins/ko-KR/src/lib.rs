...
const SERVICE_ID: &str = "adi.i18n.cli.ko-KR";

extern "C" fn plugin_info() -> PluginInfo {
    PluginInfo::new("adi.cli.ko-KR", "ADI CLI - 한국어", "1.0.0", "translation")
        .with_author("ADI Team")
        .with_description("Korean translations for ADI CLI")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        let host = (*ctx).host();
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.cli.ko-KR")
                .with_description("Korean translations for ADI CLI");
        ...
        host.info("ADI CLI Korean translation plugin initialized");
    }
    0
}
