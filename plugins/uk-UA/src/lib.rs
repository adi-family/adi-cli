...
const SERVICE_ID: &str = "adi.i18n.cli.uk-UA";

extern "C" fn plugin_info() -> PluginInfo {
    PluginInfo::new("adi.cli.uk-UA", "ADI CLI - Українська", "1.0.0", "translation")
        .with_author("ADI Team")
        .with_description("Ukrainian translations for ADI CLI")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        let host = (*ctx).host();
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.cli.uk-UA")
                .with_description("Ukrainian translations for ADI CLI");
        ...
        host.info("ADI CLI Ukrainian translation plugin initialized");
    }
    0
}
