...
const SERVICE_ID: &str = "adi.i18n.cli.de-DE";

extern "C" fn plugin_info() -> PluginInfo {
    PluginInfo::new("adi.cli.de-DE", "ADI CLI - Deutsch", "1.0.0", "translation")
        .with_author("ADI Team")
        .with_description("German translations for ADI CLI")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        let host = (*ctx).host();
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.cli.de-DE")
                .with_description("German translations for ADI CLI");
        ...
        host.info("ADI CLI German translation plugin initialized");
    }
    0
}
