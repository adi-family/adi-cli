...
const SERVICE_ID: &str = "adi.i18n.cli.zh-CN";

extern "C" fn plugin_info() -> PluginInfo {
    PluginInfo::new("adi.cli.zh-CN", "ADI CLI - 中文", "1.0.0", "translation")
        .with_author("ADI Team")
        .with_description("Chinese (Simplified) translations for ADI CLI")
...
extern "C" fn plugin_init(ctx: *mut PluginContext) -> i32 {
    unsafe {
        let host = (*ctx).host();
        let descriptor =
            ServiceDescriptor::new(SERVICE_ID, ServiceVersion::new(1, 0, 0), "adi.cli.zh-CN")
                .with_description("Chinese translations for ADI CLI");
        ...
        host.info("ADI CLI Chinese translation plugin initialized");
    }
    0
}
